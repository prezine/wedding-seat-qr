...
export default function PublicInvitePage({ params }: { params: { id: string } }) {
  const { id } = params
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 flex items-center justify-center">
        <Card className="border-rose-200 shadow-xl max-w-md">
          <CardHeader>
            <CardTitle className="text-center text-2xl font-serif">Invitation Not Found</CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-center text-muted-foreground">
              This invitation could not be found. Please check the QR code or contact the host.
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground">To celebrate our special day</p>
          </div>
          ...
          <Card className="border-rose-200 shadow-xl mb-6">
            <CardHeader className="text-center pb-4">
              ...
              <CardTitle className="text-3xl font-serif text-balance">{invitee.name}</CardTitle>
              <Badge variant={invitee.status === "Family" ? "default" : "secondary"} className="mt-2 text-sm px-4 py-1">
              ...
              <div className="grid gap-3">
                ...
                <div className="flex items-center gap-4 p-4 bg-rose-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-lg">Seat {invitee.seat_number}</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card className="border-rose-200 shadow-xl">
            <CardHeader>
              <CardTitle className="text-center text-2xl font-serif">Wedding Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-rose-50 to-pink-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-lg">Saturday, June 15th, 2025</p>
                  <p className="text-sm text-muted-foreground">Ceremony at 4:00 PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-rose-50 to-pink-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium text-lg">The Grand Ballroom</p>
                  <p className="text-sm text-muted-foreground">123 Celebration Avenue, City, State 12345</p>
                </div>
              </div>

              <div className="mt-6 p-4 bg-rose-100 rounded-lg text-center">
                <p className="text-sm text-rose-900 font-medium">We can't wait to celebrate with you!</p>
                <p className="text-xs text-rose-700 mt-1">Please arrive 15 minutes early for seating</p>
              </div>
            </CardContent>
          </Card>
